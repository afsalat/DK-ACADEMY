<%@ Page Title="" Language="C#" MasterPageFile="~/admin_page.master" AutoEventWireup="true" CodeFile="create_branch.aspx.cs" Inherits="create_branch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <asp:Panel ID="Panel3" runat="server" Height="553px" ScrollBars="none" HorizontalAlign="Center"
            ...
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" GridLines="None" HorizontalAlign="Center"
                ...
                Height="475px" AllowPaging="True" AutoGenerateColumns="False" 
                DataSourceID="SqlDataSource1" Font-Bold="False" Font-Names="Myanmar Text" 
                ForeColor="#333333">
                <RowStyle BackColor="#F7F6F3" ForeColor="#333333" BorderColor="#000066" 
                    BorderStyle="Solid" />
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="Branch_ID"
                        DataNavigateUrlFormatString="B-update.aspx?field={0}" HeaderText="EDIT"
                        Text="Update" />
                    <asp:HyperLinkField DataNavigateUrlFields="Branch_ID"
                        DataNavigateUrlFormatString="B-remove.aspx?field={0}" HeaderText="Branch Drop"
                        Text="Remove" />
                </Columns>
            ...
            <div class="style14" 
                ...
                <input ID="Button10" type="button" value="CREATE" class="style15" /></div>
