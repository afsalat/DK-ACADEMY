<%@ Page Title="" Language="C#" MasterPageFile="~/admin_page.master" AutoEventWireup="true"
    ...
    <asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
        <asp:Panel runat="server" 
            ...
            BorderColor="#5656A5">
            <asp:GridView ID="GridView1" runat="server" CellPadding="3" HorizontalAlign="Center" 
                ...
                <Columns>
                    ...
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        ...
                        <asp:HyperLinkField HeaderText="Solution" Text="To_Send" DataNavigateUrlFields="Branch_Forget" DataNavigateUrlFormatString="B-forget.aspx?field={0}"
            ...
            <asp:SqlDataSource ID="uaernameNpassword" runat="server"
                ...
                SelectCommand="SELECT [Branch_Forget] FROM [usernameNpassword]">
            </asp:SqlDataSource>
