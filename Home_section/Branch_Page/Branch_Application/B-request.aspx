<%@ Page Language="C#" AutoEventWireup="true" CodeFile="B-request.aspx.cs" Inherits="Brequest" %>
    ...
    <body id="main-b" style="text-align: center; background-color: #5F9EA0;">
        <form id="form1" runat="server" style="font-family: Arial, Helvetica, sans-serif;" method="post">
            <table id="style1" class="style1" style="text-align: center; font-family: Arial;" align="center"
                frame="border">
                <tr>
                    <td>
                        &nbsp;</td>
                ...
                <tr>
                    <td class="style6">
                        <asp:HyperLink runat="server" style="font-weight: bold; font-family: 'Arial Black'"
                            Font-Overline="False" Font-Underline="False" ForeColor="#8f8f8f" NavigateUrl="~/home.html">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            X<br />
                            <br />
                        </asp:HyperLink>
                        ...
                        <table align="center" class="style5">
                            <tr>
                                <td class="style14">
                                    ...
                                    <span lang="en-in">&nbsp;</span>
                                    <asp:TextBox ID="TextBox2" runat="server" CssClass="style12"></asp:TextBox>
                                    <span lang="en-in">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br />
                                    <span lang="en-in">&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                                            runat="server" ControlToValidate="RadioButtonList1"
                                            ErrorMessage="RequiredFieldValidator" Font-Size="Small">Enter your gander!
                                        </asp:RequiredFieldValidator>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:TextBox ID="TextBox5" runat="server" CssClass="style10" type="email">
                                    </asp:TextBox>
                                    <span lang="en-in">
                            ...
                            <tr>
                                <td align="center">
                                    ...
                                    <asp:TextBox ID="TextBox4" runat="server" TextMode="MultiLine" Height="44px"
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label9" runat="server" Text="* By Terms and condtions apply">
                                    </asp:Label>
                                    <span lang="en-in">&nbsp;</span>
